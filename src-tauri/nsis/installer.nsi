...
; Custom template based on Tauri 2.11.3 installer.nsi.
; currentUser default dir: %LOCALAPPDATA%\Programs\${PRODUCTNAME} (align with per-user MSI).
; Re-diff against upstream when upgrading Tauri.
