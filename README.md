...
打开站点后，桌面端把指针移到标题栏即可看到全部控件；平板和手机点右上角菜单。

<img src="docs/readme/feature-toolbar-desktop.png" alt="桌面端功能栏：上传、内置示例、字号、主题、纸张、换行、导出" width="720" />
...
4. **桌面**：指针移到标题栏显示上传、示例、纸张、换行、字号、主题和导出。  
   **平板 / 手机**：点右上角菜单图标打开同样的功能。
